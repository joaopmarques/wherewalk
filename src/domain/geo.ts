...
export function destination(start: LngLat, distance: number, bearing: number): LngLat {
 ...
 */
export function projectOnSegment(p: LngLat, a: LngLat, b: LngLat): { t: number; offsetM: number } {
